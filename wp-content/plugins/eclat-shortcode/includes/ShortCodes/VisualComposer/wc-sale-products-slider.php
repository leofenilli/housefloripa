...
vc_map(array(
    "name"			=> esc_html__( "Sale Products Slider", "eclat-shortcodes" ),
    "category"		=> 'WooCommerce',
    "description"	=> esc_html__( "Add a sale products slider", "eclat-shortcodes" ),
    "base"			=> "sale_products_slider",
    "class"			=> "",
    "icon"			=> "sale_products_slider",
