...
vc_map(array(
    "name"			=> esc_html__( "Featured Products Slider", "eclat-shortcodes" ),
    "category"		=> 'WooCommerce',
    "description"	=> esc_html__( "Add a featured products slider", "eclat-shortcodes" ),
    "base"			=> "featured_products_slider",
    "class"			=> "",
    "icon"			=> "featured_products_slider",
