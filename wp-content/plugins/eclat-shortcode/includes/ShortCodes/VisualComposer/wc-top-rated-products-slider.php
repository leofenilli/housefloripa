...
vc_map(array(
    "name"			=> esc_html__( "Top Rated Products Slider", "eclat-shortcodes" ),
    "category"		=> 'WooCommerce',
    "description"	=> esc_html__( "Add a top rated products slider", "eclat-shortcodes" ),
    "base"			=> "top_rated_products_slider",
    "class"			=> "",
    "icon"			=> "top_rated_products_slider",
