...
<div id="widgets">
    ...
    <p>Customize your widgets appearance and select your favorite style, icon or badge. To configure your widgets, please visit the <a href="<?php echo admin_url( 'widgets.php' )?>">widgets settings</a> screen.</p>
