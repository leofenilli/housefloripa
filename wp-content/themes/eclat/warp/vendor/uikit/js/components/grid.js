        ...
        defaults: {
            ...
            t.ready(function (i) {
                t.$("[data-uk-grid]", i).each(function () {
                    var i = t.$(this);
                    if (!i.data("grid")) {
                        t.grid(i, t.Utils.options(i.attr("data-uk-grid")))
                    }
                })
            })
        }, init: function () {
            ...
            }, this.options.gutter && (t["padding-left"] = this.gutterh, t["margin-bottom"] = this.gutterv, this.element.css("margin-left", -1 * this.gutterh)), i.attr("data-grid-prepared", "true").css(t))
